...
test_that("dispersion is reported alongside the spot mean", {
  ...
  out <- summarise_cal_levels(cal_obj(), cal_md(), val_slot = "intensity",
...
test_that("a legacy lipid column is read as analyte", {
  ...
  out <- summarise_cal_levels(cal_obj(), md, val_slot = "intensity",
                              cal_label = "Cal", id = "identifier")
...
test_that("an analyte absent from the object is an error", {
  ...
  expect_error(
    summarise_cal_levels(cal_obj(), md, val_slot = "intensity",
                         cal_label = "Cal", id = "identifier"),
...
test_that("contradictory duplicate identifiers are an error", {
  ...
  expect_error(
    summarise_cal_levels(cal_obj(), rbind(md, bad), val_slot = "intensity",
                         cal_label = "Cal", id = "identifier"),
...
test_that("a calibration label that matches no pixel is an error", {
  expect_error(
    summarise_cal_levels(cal_obj(), cal_md(), val_slot = "intensity",
