...
DT::datatable(lib, rownames = FALSE, options = list(pageLength = 10))
```

**Table 2.** The example ion library, as supplied on disk.
...
**Table 3.** The same metadata after `build_feature_meta()` has joined it to
