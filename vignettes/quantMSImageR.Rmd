...
takes `palette = "viridis"` or `"heatmap0"`; `quantile_hm()` takes a diverging
`palette` plus `group_palette` / `feature_palette` for the metadata bars. In a
YAML-driven study all four are set once in the `colours:` block:
